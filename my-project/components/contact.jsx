    ...
    return (
        <a onClick={() => {dispatch(changeApparence()); dispatch(changeConversation(userInfo.userInfo.IdUser))}} className='flex flex-row py-2 items-center px-2 hover:bg-gray-100 cursor-pointer'>
            <div className='relative'>
                ...
                <div style={{boxShadow:userInfo.userInfo.etat?"green 0px 54px 55px, green 0px -1px 2px, green 0px 0px 0px, green 0px 1px 3px, green 0px -1px 3px":"red 0px 54px 55px, red 0px -1px 2px, red 0px 0px 0px, red 0px 1px 3px, red 0px -1px 3px",backgroundColor:userInfo.userInfo.etat?"green":"red"}} className='w-2.5 h-2.5 rounded-full absolute top-2 right-4 z-30'></div>
            </div>
