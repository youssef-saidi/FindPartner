    ...
    return (
        <a href='/conversation' className='flex flex-row py-2 items-center px-2 hover:bg-gray-100 cursor-pointer'>
            <div className='relative'>
                ...
                <div style={{boxShadow:"red 0px 54px 55px, red 0px -1px 2px, red 0px 0px 0px, red 0px 1px 3px, red 0px -1px 3px",backgroundColor:"red"}} className='w-3 h-3 rounded-full absolute top-1 right-4 z-30'></div>
            </div>
