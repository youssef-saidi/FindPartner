    ...
    return (
        <div className='sticky top-0 w-screen h-16 bgPink flex flex-row items-center place-content-between z-40'>
            ...
            <div className='relative z-40'>
                <img onClick={()=>{setapparence(!apparence)}} className='cursor-pointer w-12 h-12 mr-4 rounded-full border border-4' src="/image/nour.jpg" alt="" srcset="" />
                {apparence&&
                <div className='absolute w-64 bg-white z-40 top-14 right-2 border-2 border-black'>
                    ...
                    <h3 className='text-md font-semibold flex justify-end mt-2 py-2 px-4 bg-slate-100'>Log out</h3>
                </div>}
            </div>
        </div>
    );
